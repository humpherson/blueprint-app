...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"blueprint":[{"id":1,"position":1,"stage":"Getting started","customerEmotions":"Happy","customerActions":"Create a new (+) blueprint from the menu or start by editing this one.","frontstageInteractions":"Add stages as required using the \'+ Add stage\' button.","backstageInteractions":"Modify the contents of each stage using the \'Edit\' button, \'<\' or \'>\' button to change the order.","supportProcesses":"Data persisted using local storage, or save your data and come back later.","physicalEvidence":"Built using Next.js, React, Tailwind, ChatGPT 4 and hosted on GitHub pages."}]}');
